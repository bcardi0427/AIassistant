...
### Fixed
- Fixed 'image_data' unexpected keyword argument error in chat_stream.
...
### Added
- **Native Dual-Provider Support**: Simultaneously configure both OpenAI and Google Gemini api keys.
- **Improved Routing**: Seamlessly switch between OpenAI and Gemini models in the UI; requests are automatically routed to the correct native SDK based on model prefix.
- **Gemini Native SDK**: Fully integrated `google-genai` client for high-performance interaction and native tool calling.
